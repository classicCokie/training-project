...
describe('"trackingFormReducer" works appropriately', () => {
    test('no plugins specified', () => {
        const invalidForm = {meta: {form: {a: 'b', b: 'd'}}}
        const state = reducers.trackingFormReducer(Immutable.Map(), invalidForm)
        expect(state.toJS()).toEqual({})
    })
})
